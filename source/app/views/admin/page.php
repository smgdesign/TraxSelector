...
<p class="floatright"><a class="add_button" href="/admin/module/edit/<?php echo $pID; ?>">Back to module</a><a style="margin:0 0 0 10px;" class="add_button" href="/admin/index">Back to main administration</a></p>
<h1>Edit Page</h1>
<?php
if(!empty($resp)){
?>
...
<form action="/admin/page/edit/<?php echo $pID.'/'.$id; ?>" method="post" enctype="form/multipart-data">
    <input type="hidden" name="submitted" value="TRUE" />
    <input type="hidden" name="form-token" value="<?php echo $csrf; ?>" />
    <input type="hidden" name="pID" value="<?php echo $pID; ?>" />
    <input type="hidden" name="id" value="<?php echo $id; ?>" />
    <input type="hidden" name="order" value="<?php echo (array_key_exists('ordering', $data)) ? $data['ordering'] : ''; ?>" />
    ...
    <!--a href="/admin/page/edit/<?php echo $pID; ?>">Create New</a><br />
